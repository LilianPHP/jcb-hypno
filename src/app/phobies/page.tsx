...
export const metadata: Metadata = {
  ...
  title: "Hypnose phobies et peurs à Boussy-Saint-Antoine (91)",
  description: "Peur de l'avion, des araignées, des espaces clos : se libérer d'une phobie par l'hypnose à Boussy-Saint-Antoine (91). Certifié IFHE. 1h, 80 €.",
  openGraph: {
...
export default function PhobiesPage() {
  return (
    <>
      ...
      <JsonLd data={serviceJsonLd('/phobies', "Hypnose pour les phobies et les peurs à Boussy-Saint-Antoine (91). Hypnothérapeute certifié IFHE, 15 ans d'expérience.", faqs)} />
    </>
  );
}
