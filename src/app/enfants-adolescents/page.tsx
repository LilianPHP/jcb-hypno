...
export const metadata: Metadata = {
  ...
  title: "Hypnose enfants et adolescents à Boussy-Saint-Antoine",
  description: "Anxiété, peurs, confiance en soi, stress des examens : l'hypnose pour enfants et adolescents à Boussy-Saint-Antoine (91). Certifié IFHE. 1h, 80 €.",
  openGraph: {
...
export default function EnfantsAdolescentsPage() {
  return (
    <>
      ...
      <JsonLd data={serviceJsonLd('/enfants-adolescents', "Hypnose pour les enfants et les adolescents à Boussy-Saint-Antoine (91). Hypnothérapeute certifié IFHE, 15 ans d'expérience.", faqs)} />
    </>
  );
}
