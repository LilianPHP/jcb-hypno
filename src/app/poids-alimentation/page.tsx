...
export const metadata: Metadata = {
  ...
  description: 'Grignotage, compulsions, alimentation émotionnelle : retrouvez un rapport apaisé à la nourriture grâce à l\'hypnose à Boussy-Saint-Antoine (91). Hypnothérapeute certifié IFHE. 1h · 70€.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Hypnothérapeute certifié IFHE · Grignotage, compulsions, alimentation émotionnelle · 70€ · Boussy-Saint-Antoine (91)',
    locale: 'fr_FR',
    type: 'website',
  },
};
          ...
          <div className="relative max-w-4xl mx-auto px-6 text-center">
            <FadeContent>
              ...
              <p className="text-white/60 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
                ...
                <strong className="text-white">1h · 70€ · Sans régime ni privation.</strong>
              </p>
            ...
            <FadeContent>
              <div className="text-center mb-14">
                ...
                <h2 className="font-serif text-3xl md:text-4xl font-bold text-[#1E1B4B] mt-3">
                  La séance poids & alimentation (1h · 70€)
                </h2>
              </div>
            </FadeContent>
