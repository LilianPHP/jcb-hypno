...
export default function PoidsAlimentationPage() {
  return (
    <>
      ...
      <JsonLd data={serviceJsonLd('/poids-alimentation', "Hypnose pour le poids et le rapport à l'alimentation à Boussy-Saint-Antoine (91). Hypnothérapeute certifié IFHE, 15 ans d'expérience.")} />
    </>
  );
}
