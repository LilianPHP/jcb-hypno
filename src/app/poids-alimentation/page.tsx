...
export const metadata: Metadata = {
  ...
  title: "Hypnose perte de poids à Boussy-Saint-Antoine (91)",
  description: "Grignotage, compulsions, alimentation émotionnelle : l'hypnose à Boussy-Saint-Antoine (91) ou à distance. Hypnothérapeute certifié IFHE. 1h, 80 €.",
  openGraph: {
...
export default function PoidsAlimentationPage() {
  return (
    <>
            ...
            <FadeContent>
              <div className="text-center mb-12">
                ...
                <h2 className="font-serif text-3xl font-bold text-[#1E1B4B] mt-3">
                  Vos questions sur l'hypnose et l'alimentation
                </h2>
              </div>
            </FadeContent>
      ...
      <JsonLd data={serviceJsonLd('/poids-alimentation', "Hypnose pour le poids et le rapport à l'alimentation à Boussy-Saint-Antoine (91). Hypnothérapeute certifié IFHE, 15 ans d'expérience.", faqs)} />
    </>
  );
}
