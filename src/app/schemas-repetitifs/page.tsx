...
export default function SchemasRepetitifsPage() {
  return (
    <>
      ...
      <JsonLd data={serviceJsonLd('/schemas-repetitifs', "Hypnose pour sortir des schémas répétitifs à Boussy-Saint-Antoine (91). Hypnothérapeute certifié IFHE, 15 ans d'expérience.")} />
    </>
  );
}
