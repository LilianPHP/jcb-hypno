...
import { serviceJsonLd, HORAIRES_LONG } from '@/lib/schema';
...
export const metadata: Metadata = {
  ...
  title: "Hypnose pour arrêter de fumer à Boussy-Saint-Antoine (91)",
  description: "Arrêter de fumer grâce à l'hypnose à Boussy-Saint-Antoine (91) ou à distance, avec Jean-Charles Bernard, hypnothérapeute certifié IFHE. 1h, 80 €.",
  openGraph: {
...
export default function ArretTabacPage() {
  return (
    <>
      ...
      <JsonLd data={serviceJsonLd('/arret-tabac', "Arrêt du tabac par hypnose à Boussy-Saint-Antoine (91). Hypnothérapeute certifié IFHE, 15 ans d'expérience.", faqs)} />
    </>
  );
}
