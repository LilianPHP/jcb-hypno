...
export const metadata: Metadata = {
  ...
  title: "Hypnose sommeil et insomnie à Boussy-Saint-Antoine (91)",
  description: "Endormissement difficile, réveils nocturnes : retrouver le sommeil par l'hypnose à Boussy-Saint-Antoine (91) ou à distance. Certifié IFHE. 1h, 80 €.",
  openGraph: {
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Oui. L\'hypnose repose sur la voix et sur la relation, pas sur la présence physique : le travail est le même à distance. Il vous faut simplement un endroit calme où vous ne serez pas dérangé, une connexion correcte et un casque ou des écouteurs. C\'est souvent plus pratique pour une séance en fin de journée, juste avant le coucher. Choisissez « Appel téléphonique » au moment de la réservation : Jean-Charles vous appelle sur WhatsApp à l\'heure convenue, en audio ou en visio.',
  },
];
...
export default function SommeilInsomniePage() {
  return (
    <>
            ...
            <FadeContent>
              <div className="text-center mb-12">
                ...
                <h2 className="font-serif text-3xl font-bold text-[#1E1B4B] mt-3">
                  Vos questions sur l'hypnose et le sommeil
                </h2>
              </div>
            </FadeContent>
      ...
      <JsonLd data={serviceJsonLd('/sommeil-insomnie', "Hypnose pour le sommeil et l'insomnie à Boussy-Saint-Antoine (91). Hypnothérapeute certifié IFHE, 15 ans d'expérience.", faqs)} />
    </>
  );
}
