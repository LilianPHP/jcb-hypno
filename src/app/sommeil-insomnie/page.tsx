...
export default function SommeilInsomniePage() {
  return (
    <>
      ...
      <JsonLd data={serviceJsonLd('/sommeil-insomnie', "Hypnose pour le sommeil et l'insomnie à Boussy-Saint-Antoine (91). Hypnothérapeute certifié IFHE, 15 ans d'expérience.")} />
    </>
  );
}
