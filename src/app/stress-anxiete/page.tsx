...
export default function StressAnxietePage() {
  return (
    <>
      ...
      <JsonLd data={serviceJsonLd('/stress-anxiete', "Hypnose contre le stress et l'anxiété à Boussy-Saint-Antoine (91). Hypnothérapeute certifié IFHE, 15 ans d'expérience.", faqs)} />
    </>
  );
}
